package com.study._05Collections工具类;
...
public class CollectionsDemo2 {
    public static void main(String[] args) {
        // 自定义类型定制排序1：自定义类实现Comparable接口
        System.out.println("---引用类型定制排序1：自定义类实现Comparable接口-----");
        List<Orange> oranges = new ArrayList<>();
        Orange o1 = new Orange("红橘子",654.0 ,"贼便宜~");
        Orange o2 = new Orange("黄橘子",459.0 ,"贼便宜~");
        ...
        // 自定义类型定制排序2：自定义比较器
        System.out.println("---引用类型定制排序2：自定义比较器Comparator-----");
