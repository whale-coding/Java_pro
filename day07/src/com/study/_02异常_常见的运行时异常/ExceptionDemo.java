package com.study._02异常_常见的运行时异常;
...
public class ExceptionDemo {
    public static void main(String[] args) {
        ...
        /* 1.数组索引越界异常: ArrayIndexOutOfBoundsException*/
        int[] arr ={10,20,30};
        // System.out.println(arr[3]);  // 此处出现了数组索引越界异常。代码在此处直接执行死亡！
        ...
        System.out.println(it.next());
        System.out.println(it.next());
        // System.out.println(it.next());  // 此处出现了迭代器遍历没有此元素异常。代码在此处直接执行死亡！
        ...
        String num = "23aa";
        // Integer it = Integer.valueOf(num);  // 此处出现了数学转换异常。代码在此处直接执行死亡！
