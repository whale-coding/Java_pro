...
public class CopyDemo2 {
    public static void main(String[] args) {
        try(
                //
                // 1.创建一个字节输入流管道与源文件接通
                InputStream is = new FileInputStream("day09/src/com/study/resources/test.jpg");
                // 2.创建一个字节输出流与目标文件接通
                OutputStream os = new FileOutputStream("day09/src/com/study/resources/test_copy.jpg");
