package com.study._04字节缓冲流的性能统计分析;
...
public class CopyDemo {
    public static final String SRC_FILE = "day10/src/com/study/resources/test.jpg";
    public static final String DEST_FIlE = "day10/src/com/study/resources";
    public static void main(String[] args) {
        copy01();  // 低级流一个一个字节复制，速度太慢
        copy02();  // 低级的字节流按照一个一个字节数组的形式复制 ,读取较慢
        copy03();  // 高级的缓冲字节流按照一个一个字节的形式复制 ,读取较慢
        copy04();  // 高级的字节缓冲流按照一个一个字节数组的形式复制,速度极快
    }
