...
public class ExecDemo {
    public static void main(String[] args) {
        try(
                // （1）创建一个缓冲字符输入流对象包装字符输入流接通源文件
                BufferedReader br = new BufferedReader(new FileReader("day10/src/com/study/resources/csb.txt"));
                // （5）创建一个缓冲字符输出流管道通向目标文件
                BufferedWriter bw = new BufferedWriter(new FileWriter("day10/src/com/study/resources/csb_new.txt"));
                ) {
            // （2）定义一个List集合用于存储每段文章
